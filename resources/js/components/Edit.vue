...
export default {
    ...
    methods:{
        async showDeveloper(){
            await this.axios.get(`/api/Developers/${this.$route.params.id}`).then(response=>{
                const { First_Name, Last_Name, Email, Address, Phone, Avatar } = response.data.data
                this.developer.First_Name = First_Name
                this.developer.Last_Name = Last_Name
                this.developer.Address = Address
                this.developer.Phone = Phone
                this.developer.Avatar = Avatar
        ...
        async update(){
            ...
            await this.axios.post(`/api/Developers/${this.$route.params.id}/update`,this.developer).then(response=>{
